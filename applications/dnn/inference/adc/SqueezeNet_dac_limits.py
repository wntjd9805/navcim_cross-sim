...
profiling_folder = f"{navcim_dir}/cross-sim/applications/dnn/inference/adc/profiled_dac_inputs/imagenet_SqueezeNet/"
# npy output file path
output_name = "./adc_limits/examples/dac_limits_SqueezeNet.npy"
