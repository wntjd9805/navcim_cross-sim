...
profiling_folder = "./profiled_dac_inputs/imagenet_VGG19/"
# npy output file path
output_name = "./adc_limits/examples/dac_limits_VGG19.npy"

# Quantization loss function settings
Nbits = 0 # not necessarily the ADC resolution to be used
norm_ord = 1
