...
profiling_folder = f"{navcim_dir}/cross-sim/applications/dnn/inference/adc/profiled_adc_inputs/imagenet_SqueezeNet_"+\
			str(NrowsMax)+"rows_"+str(NcolsMax)+"cols_"+str(Nslices)+"slices_"+xbar_style+ibit_msg+"/"

# npy output file path
output_name = f"{navcim_dir}/cross-sim/applications/dnn/inference/adc/adc_limits/examples/adc_limits_SqueezeNet_"+\
...
###
### SqueezeNet specific parameters
###

# Layer nums for SqueezeNet conv and dense layers
layerNums = [0, 2, 3, 4, 6, 7, 8, 11, 12, 13, 15, 16, 17, 20, 21, 22, 24, 25, 26, 28, 29, 30, 32, 33, 34, 36]


NrowsList_unsplit = np.array([27, 64, 16, 144, 128, 16, 144, 128, 32, 288, 256, 32, 288, 256, 48, 432, 384, 48, 432, 384, 64, 576, 512, 64, 576, 512])
