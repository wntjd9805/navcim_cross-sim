...
profiling_folder = f"{navcim_dir}/cross-sim/applications/dnn/inference/adc/profiled_dac_inputs/imagenet_MobileNetV2/"
# npy output file path
output_name = "./adc_limits/examples/dac_limits_mobilenet_v2.npy"
...
layerNums = [4, 9, 14, 19, 24, 29, 34, 39, 44, 53, 58, 63, 68, 73, 78, 87, 92, 97, 106, 111, 116, 121, 126, 131, 140, 145, 150, 159, 164, 169, 178, 183, 188, 193, 198, 203, 212, 217, 222, 231, 236, 241, 246, 251, 256, 265, 270, 275, 284, 289, 294, 299, 310]
...
print("Profiled activation limits:")
print(DAC_limits)
