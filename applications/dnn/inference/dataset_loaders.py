...
datasets_root = f"{navcim_dir}/cross-sim/applications/dnn/data/datasets/"
...
def load_data_mnist(path=datasets_root+'mnist/mnist.npz',\
...
def load_data_fashion_mnist(path=datasets_root+'fashion_mnist/',\
    nstart=None,nend=None,calibration=False,training=False):
...
def load_cifar_10(path=datasets_root+'cifar10/',\
...
def load_cifar_100(path=datasets_root+'cifar100/',\
    nstart=None,nend=None,calibration=False,subtract_pixel_mean=False):
...
def load_imagenet(option, calibration=False, nstart=0,nend=9999):
    ...
    ####
        ...
        if calibration:
            print("Loading MLPerf calibration subset of ImageNet (Torchvision preprocessing)")
            x_test = np.load(path + "x_val_torch_cal.npy")
        elif nend <= 50:
            print("Loading first 50 images of ImageNet validation set (Torchvision preprocessing)")
