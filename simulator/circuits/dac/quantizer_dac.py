...
class QuantizerDAC(IDAC):
    def __init__(self, dac_params, core_params):
        ...
        # print("self.signed", self.signed)
        # print("QuantizerDAC.__init__: self.min = ", self.min, "self.max = ", self.max)
        # print("QuantizerDAC.__init__: self.core_params.min = ", self.core_params.min, "self.core_params.max = ", self.core_params.max)
        # print("QuantizerDAC.__init__: self.core_params.range = ", self.core_params.range)
    ...
    def convert(self, vector):
        ...
        # print("QuantizerDAC.convert: bits = ", vector)
        if not self.bits or self.bits == 0:
            return vector

        # Clip vector
        input_ = vector.clip(self.min, self.max)
        # print("QuantizerDAC.convert: input_ = ", input_, self.levels)
        # print("QuantizerDAC.__init__: self.min = ", self.min, "self.max = ", self.max)
        # Quantize
        ...
        # print("QuantizerDAC.convert: input_ = ", input_)
