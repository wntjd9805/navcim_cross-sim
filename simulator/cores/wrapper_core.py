...
class WrapperCore(ICore, metaclass=ABCMeta):
    ...
    def set_matrix(self, matrix, weight_limits=None, error_mask=None):
        ...
        # print("self.min, self.max",self.min, self.max)
        # print("self.weight_scale",self.weight_scale)
        # print("self.out_prefactor",self.out_prefactor)
        ...
        # self.vmm_in_scale= 1
        # self.vmm_out_scale= 1
        # self.mvm_in_scale= 1
        # self.mvm_out_scale= 1
        # self.weight_scale = 1
    ...
    def set_mvm_inputs(self, vector, input_limits=None):
        ...
        # print("self.mvm_out_scale",self.mvm_out_scale)
        # print("WrapperCore.set_mvm_inputs: vector = ", vector)
        # print("WrapperCore.set_mvm_inputs: input_limits = ", input_limits)
        # print("WrapperCore.set_mvm_inputs: self.mvm_input_percentile_scaling = ", self.mvm_in_scale)
    ...
    def run_xbar_mvm(self, vector=None, input_limits=None):
        ...
        # print("juseong",self.mvm_out_scale)
